...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AGENT_BROWSER_PASSIVE</code></td><td>Launch local headed Chrome for human login without attaching to page targets. Page automation is unavailable until the session is relaunched without this variable.</td><td>(disabled)</td></tr>
